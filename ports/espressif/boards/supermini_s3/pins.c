...
//
// SPDX-FileCopyrightText: Copyright (c) 2025 David Richmond
//
...
static const mp_rom_map_elem_t board_module_globals_table[] = {
    ...
    // Numbering breaks up for TX/RX but it's still the top side, left column
    ...
    // On the right side, 3.3V, GND, and 5V follow heading upwards
    ...
    { MP_ROM_QSTR(MP_QSTR_D15), MP_ROM_PTR(&pin_GPIO17) },
    ...
    // Bottom pins (flat pads) centre (inner left) column (bottom to top)
    ...
    // Bottom pins (flat pads) right column (bottom to top)
